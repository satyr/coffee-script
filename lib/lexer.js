(function() {
  ...
  JS_KEYWORDS = ['true', 'false', 'null', 'this', 'if', 'else', 'switch', 'for', 'while', 'try', 'catch', 'finally', 'return', 'throw', 'break', 'continue', 'new', 'delete', 'typeof', 'in', 'instanceof', 'debugger', 'super', 'class', 'extends'];
