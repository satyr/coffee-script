(function() {
  ...
  exports.ValueNode = (function() {
    ...
    ValueNode.prototype.SOAK = " == null ? null : ";
      ...
      for (_b = 0, _d = _c.length; _b < _d; _b++) {
        (function() {
          ...
          if (prop.soakNode) {
            ...
            return complete += this.SOAK + (baseline += prop.compile(op));
          } else {
  ...
  exports.IfNode = (function() {
    ...
    IfNode.prototype.bodyNode = function() {
      return this.body == null ? null : this.body.unwrap();
    };
    IfNode.prototype.elseBodyNode = function() {
      return this.elseBody == null ? null : this.elseBody.unwrap();
    };
