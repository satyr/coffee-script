  ...
  grammar = {
    ...
    Range: [
      o("Expression TO Expression", function() {
        return new Range($1, $3, new Literal(1));
      }), o("Expression TO Expression BY Expression", function() {
        return new Range($1, $3, $5);
      })
    ],
    Array: [
      o("[ ]", function() {
    ...
    ForSource: [
      ...
      }), o("FORIN Range", function() {
        return {
          source: $2
        };
      }), o("FORIN Range WHEN Expression", function() {
        return {
          source: $2,
          guard: $4
        };
